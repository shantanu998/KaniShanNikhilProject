...
export default function Grid(){
  ...
  //console.log(clist.length);
    ...
    return (
          ...
          <nav className="nav-wrapper">
            <div className="container">
                <ul className="right">
                    ...
                    <li><Link to="/firstPage/" className="nav-text" style={{textDecoration:'none'}}>Shop</Link></li>
        ...
        path="/:id"
        exact strict
        component={({ match }) => <LoadableDetails>{[match,list]}</LoadableDetails>}></Route>
          <Route path="/firstPage/" exact strict component={() => <LoadableShop>{list}</LoadableShop>}>
          </Route>
